    ...
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          barWidth: 2,
          dotData: const FlDotData(show: false),//.map((color) => color.withOpacity(0.15)).toList()
      ...
      lineTouchData: LineTouchData(
        touchTooltipData: LineTouchTooltipData(
          getTooltipColor: (touchedSpot) => const Color(0xFF343434), //tooltipBgColor: const Color(0xFF343434),
